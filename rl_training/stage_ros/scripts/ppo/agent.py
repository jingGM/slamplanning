...
class Policy(object):
    ...
    def _policy_net(self):
        ...
        net = tl.layers.MinPool1d(net, filter_size=3, strides=2, name='min_pooling1')
        net = tl.layers.MinPool1d(net, filter_size=3, strides=2, name='min_pooling2')
        net = tl.layers.MinPool1d(net, filter_size=3, strides=2, name='min_pooling3')
...
class Value(object):
    ...
    def _value_net(self):
        ...
        net = tl.layers.MinPool1d(net, filter_size=3, strides=2, name='min_pooling1_value')
        net = tl.layers.MinPool1d(net, filter_size=3, strides=2, name='min_pooling2_value')
        net = tl.layers.MinPool1d(net, filter_size=3, strides=2, name='min_pooling3_value')
